...
APPNAME = "Tobalaba"
else ifeq ($(CHAIN),xerom)
APP_LOAD_PARAMS += --path "44'/1313500'"
DEFINES += CHAINID_UPCASE=\"XEROM\" CHAINID_COINNAME=\"XEROM\" CHAIN_KIND=CHAIN_KIND_XEROM CHAIN_ID=1313500
APPNAME = "XEROM"
else
ifeq ($(filter clean,$(MAKECMDGOALS)),)
$(error Unsupported CHAIN - use ethereum, ethereum_classic, expanse, poa, rsk, rsk_testnet, ubiq, wanchain, kusd, musicoin, pirl, akroma, atheios, callisto, ethersocial, ellaism, ether1, ethergem, gochain, mix, reosc, hpb, tomochain, tobalaba, xerom)
endif
endif
...
listvariants:
	@echo VARIANTS CHAIN ethereum ethereum_classic expanse poa rsk rsk_testnet ubiq wanchain kusd pirl akroma atheios callisto ethersocial ether1 gochain musicoin ethergem mix ellaism reosc hpb tomochain tobalaba xerom
